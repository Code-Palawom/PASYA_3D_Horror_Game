...
//     version 1.18.0
//     from Assets/Scripts/Player/CameraInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Player/CameraInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CameraInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Mouse"",
            ""id"": ""f5686166-0b09-4cff-bf07-08c54577187b"",
            ""actions"": [
                {
                    ""name"": ""Scroll"",
                    ""type"": ""Value"",
                    ""id"": ""04273fc2-89ff-4226-ab97-f9dca531214b"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""6ecfda28-c67e-49ab-92fb-786f2b2ed158"",
                    ""path"": ""<Mouse>/scroll"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@CameraInput()
    {
        UnityEngine.Debug.Assert(!m_Mouse.enabled, "This will cause a leak and performance issues, CameraInput.Mouse.Disable() has not been called.");
    }
    ...
    public struct MouseActions
    {
        ...
        /// </summary>
        public MouseActions(@CameraInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
