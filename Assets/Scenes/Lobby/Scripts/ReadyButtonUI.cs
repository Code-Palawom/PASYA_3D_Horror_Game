...
public class ReadyButtonUI : NetworkBehaviour {
    ...
    void TryToggleReady() {
        ...
        LobbyReadyManager.Instance.SetReadyRpc(NetworkManager.Singleton.LocalClientId, _isReady, AuthManager.Instance.CurrentProfile?.DisplayName ?? SettingsManager.Instance.Current.playerName);
    }
